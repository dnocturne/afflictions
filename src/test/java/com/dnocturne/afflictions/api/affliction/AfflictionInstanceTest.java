...
class AfflictionInstanceTest {
    ...
    class CustomData {
        ...
        void getData_withDefault_returnDefault() {
            AfflictionInstance instance = new AfflictionInstance(player.getUniqueId(), testAffliction);
            assertEquals("default", instance.getData("nonexistent", "default"));
        }
        ...
        void getData_withDefault_returnsValueIfExists() {
            ...
            assertEquals("value", instance.getData("key", "default"));
        }
        ...
        void data_storesDifferentTypes() {
            ...
            assertEquals("text", instance.<String>getData("string"));
            assertEquals(42, instance.<Integer>getData("integer"));
            assertEquals(true, instance.<Boolean>getData("boolean"));
            assertEquals(3.14, instance.<Double>getData("double"));
        }
    }
