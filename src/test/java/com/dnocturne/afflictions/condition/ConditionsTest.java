...
/**
 * Tests for Conditions factory and condition composition.
 */
...
class ConditionsTest {
    ...
    class TimeConditions {
        ...
        void isDay_duringDay_returnsTrue() {
            ...
            assertTrue(Conditions.isDay().test(player));
        }
        ...
        void isDay_duringNight_returnsFalse() {
            ...
            assertFalse(Conditions.isDay().test(player));
        }
        ...
        void isNight_duringNight_returnsTrue() {
            world.setTime(18000L); // Midnight
            assertTrue(Conditions.isNight().test(player));
        }
        ...
        void isNight_duringDay_returnsFalse() {
            world.setTime(6000L); // Noon
            assertFalse(Conditions.isNight().test(player));
        }

        @Test
        @DisplayName("isTimeInRange() works for normal range")
        void isTimeInRange_normalRange_works() {
            Condition inRange = Conditions.isTimeInRange(6000L, 12000L);
        ...
        void isTimeInRange_wrapAround_works() {
            ...
            Condition inRange = Conditions.isTimeInRange(22000L, 2000L);
    ...
    class MoonPhaseConditions {
        ...
        void isFullMoon_onFullMoon_returnsTrue() {
            ...
            assertTrue(Conditions.isFullMoon().test(player));
        }
        ...
        void isFullMoon_onNewMoon_returnsFalse() {
            ...
            assertFalse(Conditions.isFullMoon().test(player));
        }
        ...
        void isBrightMoon_forBrightPhases_returnsTrue() {
            ...
            world.setFullTime(0);
            assertTrue(Conditions.isBrightMoon().test(player));
        ...
        void isBrightMoon_forDarkPhases_returnsFalse() {
            ...
            assertFalse(Conditions.isBrightMoon().test(player));
        ...
        void isDarkMoon_isNegationOfBrightMoon() {
            world.setFullTime(0); // Full Moon
            assertFalse(Conditions.isDarkMoon().test(player));

            world.setFullTime(4 * TimeUtil.TICKS_PER_DAY); // New Moon
            assertTrue(Conditions.isDarkMoon().test(player));
        }
    }
    ...
    class EquipmentConditions {
        ...
        void hasHelmet_withHelmet_returnsTrue() {
            ...
            assertTrue(Conditions.hasHelmet().test(player));
        }
        ...
        void hasHelmet_withoutHelmet_returnsFalse() {
            ...
            assertFalse(Conditions.hasHelmet().test(player));
        }
        ...
        void noHelmet_isNegationOfHasHelmet() {
            ...
            inventory.setHelmet(null);
            assertTrue(Conditions.noHelmet().test(player));

            inventory.setHelmet(new ItemStack(Material.DIAMOND_HELMET));
            assertFalse(Conditions.noHelmet().test(player));
        }
    }
    ...
    class WorldEnvironmentConditions {
        ...
        void isInOverworld_inOverworld_returnsTrue() {
            ...
            assertTrue(Conditions.isInOverworld().test(player));
        }
        ...
        void isInOverworld_inNether_returnsFalse() {
            ...
            assertFalse(Conditions.isInOverworld().test(player));
            assertTrue(Conditions.isInNether().test(player));
        }
        ...
        void isInEnd_inEnd_returnsTrue() {
            ...
            assertTrue(Conditions.isInEnd().test(player));
            assertFalse(Conditions.isInOverworld().test(player));
        }
    }
    ...
    class WeatherConditions {
        ...
        void hasStorm_duringStorm_returnsTrue() {
            world.setStorm(true);
            assertTrue(Conditions.hasStorm().test(player));
        }
        ...
        void hasStorm_whenClear_returnsFalse() {
            ...
            assertFalse(Conditions.hasStorm().test(player));
        }
        ...
        void isClearWeather_isNegationOfHasStorm() {
            world.setStorm(true);
            assertFalse(Conditions.isClearWeather().test(player));

            world.setStorm(false);
            assertTrue(Conditions.isClearWeather().test(player));
        }
        ...
        void isThundering_duringThunder_returnsTrue() {
            ...
            assertTrue(Conditions.isThundering().test(player));
        }
    }
    ...
    class CompositeConditionsTest {
        ...
        void isFullMoonNight_requiresBoth() {
            Condition condition = Conditions.isFullMoonNight();
    ...
    @Nested
    @DisplayName("Condition Constants")
    class ConditionConstants {

        @Test
        @DisplayName("ALWAYS returns true")
        void always_returnsTrue() {
            assertTrue(Condition.ALWAYS.test(player));
        }

        @Test
        @DisplayName("NEVER returns false")
        void never_returnsFalse() {
            assertFalse(Condition.NEVER.test(player));
        }
    }
    ...
    class ConditionDescription {
        ...
        void conditions_haveMeaningfulDescriptions() {
            assertEquals("isDay", Conditions.isDay().describe());
            assertEquals("isNight", Conditions.isNight().describe());
            assertEquals("isFullMoon", Conditions.isFullMoon().describe());
            assertEquals("hasHelmet", Conditions.hasHelmet().describe());
        }
    }
}
