...
import com.dnocturne.afflictions.registry.AfflictionRegistry;
...
public class AfflictionManager {
    ...
    private final AfflictionRegistry registry;
    ...
    private void tick() {
        ...
        for (AfflictedPlayer afflictedPlayer : playerManager.getAllAfflicted()) {
     ...
     */
    public AfflictionRegistry getRegistry() {
        return registry;
    }
